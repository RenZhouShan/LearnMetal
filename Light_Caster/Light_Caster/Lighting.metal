            ...
            uint vid [[vertex_id]])
{
    ...
    float4x4 modelMatrix =  uniforms.rotateZMatrix*uniforms.rotateYMatrix * uniforms.rotateXMatrix * uniforms.scaleMatrix;// * uniforms.transformMatrix;
    float4 position = vert[vid].position;
    float4 normal = nor(uniforms.rotateZMatrix*uniforms.rotateYMatrix * uniforms.rotateXMatrix * vert[vid].normal);
