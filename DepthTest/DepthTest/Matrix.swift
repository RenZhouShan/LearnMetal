...
struct Matrix4x4 {
  ...
  /*       let yScale = 1 / tan(fovRadians * 0.5)
    ...
    static func cameraView(_ cameraPos: SIMD4<Float>, _ targetPos: SIMD4<Float>,
        ...
        let haha = cross(SIMD3<Float>(xaxis.x, xaxis.y, xaxis.z), SIMD3<Float>(zaxis.x, zaxis.y, zaxis.z))
...
struct Light{
    ...
    let flashLightOuterCutOff:SIMD4<Float>;
}
